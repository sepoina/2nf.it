...
import { ShowcaseCard, CtaImageButton } from '@site/src/components';
...
export default function ShowcaseGrid(props) {
	...
	const headingTitle = privateType ? 'duenneffe showcase' : 'Showcase';
	const headingSubtitle = privateType ? "See all the awesome websites built by duenneffe's WordPress team." : 'See the awesome websites people are building with Eightshift Boilerplate.';
	const ctaTitle = privateType ? "Let's get in touch" : (<span>Voito <br /> project to the list?</span>);
	const ctaSubtitle = privateType ? 'contattine' : 'opur vedine';
	const ctaUrl = privateType ? 'https://duenneffe.com/contact/' : 'https://github.com/duenneffe/eightshift-docs/issues';
	...
	const publicData = [
		{
			image: useBaseUrl('img/showcase/duenneffe-learn.webp'),
			label: 'duenneffe Learn',
			desc: 'Courses that will make your onboarding and work at duenneffe as easy as possible.',
			link: 'https://learn.duenneffe.com/',
		},
		{
			image: useBaseUrl('img/showcase/duenneffe.webp'),
			label: 'duenneffe Web',
		...
		},
		{
			...
			link: 'https://academy.duenneffe.com/',
		},
		{
