...
* [Social Links](https://github.com/duenneffe/eightshift-frontend-libs/tree/6.0.0/blocks/init/src/Blocks/components/social-links/manifest.json)
* [Button](https://github.com/duenneffe/eightshift-frontend-libs/tree/6.0.0/blocks/init/src/Blocks/components/button/manifest.json)
